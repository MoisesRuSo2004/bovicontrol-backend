...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Crear una nueva finca' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar todas las fincas' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener detalle de una finca' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar datos de una finca' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Eliminar una finca' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
