...
export declare class HealthController {
    ...
    findAllVaccinations(farmId: string, animalId?: string, from?: string, to?: string, page?: string, limit?: string): Promise<import("../../common/utils/pagination.util").PaginatedResult<{
        vaccine: {
            id: string;
            name: string;
        };
    ...
    getUpcomingVaccinations(farmId: string, daysAhead?: string): Promise<({
        vaccine: {
            id: string;
            name: string;
        };
    ...
    findAllTreatments(farmId: string, animalId?: string, status?: TreatmentStatus, from?: string, to?: string, page?: string, limit?: string): Promise<import("../../common/utils/pagination.util").PaginatedResult<{
        animal: {
            id: string;
            name: string | null;
            tagNumber: string;
    ...
    updateTreatment(id: string, farmId: string, dto: Partial<CreateTreatmentDto>): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        notes: string | null;
    ...
    findAllDiseases(farmId: string, animalId?: string, page?: string, limit?: string): Promise<import("../../common/utils/pagination.util").PaginatedResult<{
        animal: {
            id: string;
            name: string | null;
            tagNumber: string;
    ...
    updateDisease(id: string, farmId: string, dto: Partial<CreateDiseaseDto>): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        name: string;
    ...
    findAllAlerts(farmId: string, isResolved?: string, page?: string, limit?: string): Promise<import("../../common/utils/pagination.util").PaginatedResult<{
        animal: {
            id: string;
            name: string | null;
            tagNumber: string;
    ...
    getUpcomingAlerts(farmId: string, daysAhead?: string): Promise<({
        animal: {
            id: string;
            name: string | null;
            tagNumber: string;
