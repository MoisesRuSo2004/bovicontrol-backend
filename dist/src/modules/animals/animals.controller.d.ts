...
export declare class AnimalsController {
    ...
    getStats(farmId: string): Promise<{
        ...
        males: number;
        pregnancies: number;
        bySex: (import("@prisma/client").Prisma.PickEnumerable<import("@prisma/client").Prisma.AnimalGroupByOutputType, "sex"[]> & {
            _count: number;
        })[];
        byStatus: (import("@prisma/client").Prisma.PickEnumerable<import("@prisma/client").Prisma.AnimalGroupByOutputType, "status"[]> & {
            _count: number;
        })[];
    }>;
    getCategories(farmId: string): Promise<{
        total: number;
        categories: {
            key: string;
            count: number;
    ...
    updatePhoto(id: string, farmId: string, file: Express.Multer.File): Promise<{
        breed: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    addGalleryPhoto(id: string, farmId: string, file: Express.Multer.File): Promise<{
        url: string;
        id: string;
        createdAt: Date;
        animalId: string;
    }>;
    removeGalleryPhoto(id: string, photoId: string, farmId: string): Promise<void>;
}
